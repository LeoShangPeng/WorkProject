...
/**
 * Abstract class that allows to define validation rules for {@link android.view.View}s.
 *
 * @author Ragunath Jawahar <rj@mobsandgeeks.com>
 *
 * @param <T> Usually the {@link android.view.View} this rule is applicable for. Sometimes may be interfaces
 * such as {@link android.widget.Checkable} which are indeed {@link android.view.View} components or widgets.
 */
