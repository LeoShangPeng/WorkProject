...
public class UtilsTime {
	...
	public static UtilsTime getInstance() {
		return new UtilsTime();
	}

	public static UtilsTime getInstance(String year, String month) {
		UtilsTime th = new UtilsTime();
	...
	public static UtilsTime getInstance(String year, String month, String day) {
		UtilsTime th = new UtilsTime();
	 ...
	 * @return
	 */
	public static UtilsTime getInstance(int year, int month, int day) {
		UtilsTime th = new UtilsTime();
	 ...
	 */
	public static UtilsTime getInstance(String date_time) {
	...
	public static UtilsTime getInstance(long timeInMillis) {
		UtilsTime th = new UtilsTime();
		th.set(timeInMillis);
		return th;
	}
	...
	public String getYearSimpleStr() {
		...
		return UtilsString.addPrefixZero(year);
	...
	public String getMonthStr() {
		return UtilsString.addPrefixZero(this.getMonth());
	}
	...
	public String getDayStr() {
		return UtilsString.addPrefixZero(this.getDay());
	}
	...
	public String getHourStr() {
		return UtilsString.addPrefixZero(this.getHour());
	}
	...
	public String getMinuteStr() {
		return UtilsString.addPrefixZero(this.getMinute());
	}
	...
	public String getSecondStr() {
		return UtilsString.addPrefixZero(this.getSecond());
	}
	...
	public String getYYYYMMDDPrevious() {
		UtilsTime previousDay = getTimeHandlerPrevious();
	...
	public String getYYYYMMDDNext() {
		UtilsTime nextDay = getTimeHandlerNext();
	 ...
	 * @return
	 */
	public UtilsTime getTimeHandlerPrevious() {
		long todayTimeInMillis = this.getTimeInMillis();
		UtilsTime previousDay = UtilsTime.getInstance(todayTimeInMillis - 24 * 3600 * 1000l);
		return previousDay;
	}
	 ...
	 * @return
	 */
	public UtilsTime getTimeHandlerNext() {
		long todayTimeInMillis = this.getTimeInMillis();
		UtilsTime nextDay = UtilsTime.getInstance(todayTimeInMillis + 24 * 3600 * 1000l);
		return nextDay;
	}
	...
	public String getYYYYMMPrevious() {
		...
		StringBuffer sbf = new StringBuffer();
		sbf.append(year).append("-").append(UtilsString.addPrefixZero(previousMonth));
		return sbf.toString();
	}
	...
	public String getYYYYMMNext() {
		...
		StringBuffer sbf = new StringBuffer();
		sbf.append(year).append("-").append(UtilsString.addPrefixZero(nextMonth));
		return sbf.toString();
	}
	...
	public static String now() {
		return UtilsTime.getInstance().getTimestamp().toString().substring(0, 19);
	}
	...
	public String getPeriodStr(long timeInMillis) {
		...
		if (result > 0) {
			sbf.append(UtilsString.addPrefixZero((int) result)).append(":");
		...
		sbf.append(UtilsString.addPrefixZero((int) result));
		return sbf.toString();
	}

	public static UtilsTime linuxTimeToWinTime(UtilsTime timeHandler) {
	...
	public static String formatDate(int year, int month, int day) {
		...
		sbf.append(year);
		sbf.append("-");
		sbf.append(UtilsString.addPrefixZero(month + 1));
		sbf.append("-");
		sbf.append(UtilsString.addPrefixZero(day));
		return sbf.toString();
	}
